            ...
            if (isset($_POST["email"]) && (!empty($_POST["email"]))) {
                ...
                if ($error != "") {
                 ...
                 //   $output.='<p>Please click on the following link to reset your password.</p>';
                    ...
                    $output.='<p>To reset your password click <a href="http://localhost/book_shop/reset-password.php?key=' . $key . '&email=' . $email . '&action=reset" target="_blank">here</a></p>';
                    $body = $output;
                    ...
                    $mail->SMTPAuth = true;
                    $mail->Username = "bookshop2122@gmail.com"; // Enter your email here
                    $mail->Password = "Bookshop123."; //Enter your password here
                    $mail->Port = 587;
                    $mail->IsHTML(true);
